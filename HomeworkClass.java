/**
 * Created by stacyzolnikov on 6/20/16.
 */
...
public class HomeworkClass
{
    public static void main(String[] args) {
        ...
        // I predicted it would come out to 3 because 3 can only go into 10 3 times. If I used the modulo, it would come out to 1 since that would be the remainder. According to Google, Integer division is division in which the fractional part (remainder) is discarded.
    }
}